...
import { Users, Package, DollarSign, Activity, Settings, CheckCircle, LayoutDashboard } from 'lucide-react';
                ...
                <div className="flex justify-between items-center mb-8">
                    ...
                    <div className="flex space-x-3">
                        <button
                            ...
                            className="bg-white border border-gray-300 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-50 transition-colors flex items-center font-medium"
                        >
                            {view === 'dashboard' ? (
                                <><Settings className="w-4 h-4 mr-2" /> Content Settings</>
                            ) : (
