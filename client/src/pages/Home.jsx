...
import {
    ArrowRight, Zap, Upload, Sliders, ShieldCheck, Truck,
    Star, CheckCircle, Award, Clock, Users, Package
} from 'lucide-react';
...
/* ─── data ─── */
const STATS = [
    { value: '12K+', label: 'Happy Customers', icon: <Users className="h-6 w-6" /> },
    { value: '99%',  label: 'On-Time Delivery',  icon: <Clock className="h-6 w-6" /> },
    { value: '50+',  label: 'Print Products',     icon: <Package className="h-6 w-6" /> },
    { value: '5★',   label: 'Average Rating',     icon: <Star className="h-6 w-6" /> },
];

const HOW_IT_WORKS = [
    { icon: <Upload className="h-8 w-8 text-brand-red" />,    title: '1. Upload Design',    desc: 'Provide your print-ready artwork or use our professional templates.' },
    { icon: <Sliders className="h-8 w-8 text-brand-dark" />,  title: '2. Configure Options', desc: 'Select your preferred paper weight, finish, and quantity.' },
    { icon: <ShieldCheck className="h-8 w-8 text-brand-red" />, title: '3. Secure Payment',  desc: 'Checkout securely via credit card, mobile wallet, or InstaPay.' },
    { icon: <Truck className="h-8 w-8 text-brand-dark" />,    title: '4. Fast Delivery',    desc: 'We print immediately and ship directly to your door.' },
];

const SERVICES = [
    { title: 'Business Cards',      desc: 'Premium thick cards with multiple finishes.',  img: 'https://images.pexels.com/photos/6214474/pexels-photo-6214474.jpeg?auto=compress&cs=tinysrgb&w=800' },
    { title: 'Marketing Posters',   desc: 'Vibrant large-format printing.',                img: 'https://images.pexels.com/photos/1779487/pexels-photo-1779487.jpeg?auto=compress&cs=tinysrgb&w=800' },
    { title: 'Custom Packaging',    desc: 'Branded boxes and mailing materials.',          img: 'https://images.pexels.com/photos/6214476/pexels-photo-6214476.jpeg?auto=compress&cs=tinysrgb&w=800' },
];

const FEATURES = [
    { icon: <Award className="h-8 w-8 text-brand-red" />,       title: 'Premium Quality',    desc: 'We use only the finest paper stocks and inks for colours that pop and materials that last.' },
    { icon: <Clock className="h-8 w-8 text-brand-dark" />,      title: 'Fast Turnaround',    desc: 'Same-day and next-day production options available for rush orders.' },
    { icon: <CheckCircle className="h-8 w-8 text-brand-red" />, title: 'Proof Approval',     desc: 'We send a digital proof before printing so you are 100% happy with the result.' },
    { icon: <Truck className="h-8 w-8 text-brand-dark" />,      title: 'Nationwide Delivery', desc: 'Fast, tracked delivery to any address across Egypt.' },
];
        ...
        <div className="pt-20 overflow-x-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full grid md:grid-cols-2 gap-16 items-center py-16">
                    ...
                    <div>
                        <motion.div
                            ...
                            transition={{ duration: 0.6, ease: [0.22, 1, 0.36, 1], delay: 0.0 }}
                            className="inline-flex items-center space-x-2 bg-white px-4 py-2 rounded-full text-sm font-semibold text-brand-red mb-8 shadow-sm border border-red-100"
                        >
                        ...
                        >
                            Premium printing for professionals. Upload your designs, configure your materials, and get stunning results delivered to your door.
                        </motion.p>
                    ...
                    <div className="hidden md:block relative h-[580px]">
                        ...
                        >
                            <div
                                ...
                                style={{ backgroundImage: "url('https://images.pexels.com/photos/159711/books-bookstore-book-reading-159711.jpeg?auto=compress&cs=tinysrgb&w=800')" }}
                            />
                            <div className="absolute inset-0 bg-gradient-to-t from-brand-dark/80 via-transparent to-transparent" />
                            <div className="absolute bottom-6 left-6 text-white z-10">
                                <p className="text-xs font-semibold text-red-300 uppercase tracking-widest mb-1">Premium Print</p>
                        ...
                        >
                            <div
                                className="w-full h-32 bg-cover bg-center group-hover:scale-110 transition-transform duration-700"
                            ...
                            <div className="absolute inset-0 bg-gradient-to-t from-brand-dark/90 via-black/20 to-transparent p-3 flex flex-col justify-end">
                                <span className="bg-green-500 text-white text-[10px] font-bold px-2 py-0.5 rounded w-max mb-1 uppercase tracking-wider">In Stock</span>
                                <span className="text-white font-bold text-sm flex items-center gap-1"><Zap className="w-3 h-3 text-yellow-400" /> Fast Turnaround</span>
                            </div>
                        </motion.div>
                        ...
                        >
                            <div
                                className="w-full h-36 bg-cover bg-center group-hover:scale-110 transition-transform duration-700"
                            ...
                            />
                            <div className="absolute inset-0 bg-gradient-to-t from-brand-dark/90 via-black/20 to-transparent p-3 flex flex-col justify-end">
                                <span className="bg-brand-red text-white text-[10px] font-bold px-2 py-0.5 rounded w-max mb-1 uppercase tracking-wider">Best Seller</span>
                                <span className="text-white font-bold text-sm">Premium Business Cards</span>
                            </div>
                        </motion.div>
                        ...
                        >
                            <div className="bg-white px-5 py-2.5 rounded-full border border-gray-100 shadow-xl flex items-center gap-2.5">
                                ...
                                <span className="text-sm font-bold text-brand-dark">Systems Online</span>
                            </div>
                        </motion.div>
                    </div>
                </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-20">
                        <motion.p
                            ...
                            className="text-brand-red font-bold uppercase tracking-widest text-sm mb-3"
                        >Simple Process</motion.p>
                        <motion.h2
                        ...
                        >Four simple steps to bring your creative vision to life with uncompromising quality.</motion.p>
                    </div>
            ...
            <section className="py-28 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <motion.p initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} className="text-brand-red font-bold uppercase tracking-widest text-sm mb-3">What We Offer</motion.p>
                        <motion.h2 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-4xl md:text-5xl font-black text-brand-dark mb-4">Popular Services</motion.h2>
                        <motion.p initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }} className="text-xl text-gray-500 max-w-2xl mx-auto">Everything you need to make a lasting impression.</motion.p>
                    </div>
                    <div className="grid md:grid-cols-3 gap-8">
                        {SERVICES.map((s, i) => (
                            <motion.div
                                ...
                                transition={{ duration: 0.6, delay: i * 0.15 }}
                                whileHover={{ y: -8 }}
                                className="group rounded-2xl overflow-hidden shadow-sm hover:shadow-2xl hover:shadow-brand-dark/10 border border-gray-100 bg-white transition-all duration-300"
                            >
            ...
            <section className="py-28 bg-brand-dark relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="text-center mb-16">
                        <motion.p initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} className="text-brand-red font-bold uppercase tracking-widest text-sm mb-3">Our Edge</motion.p>
                        <motion.h2 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-4xl md:text-5xl font-black text-white mb-4">Why Choose Us?</motion.h2>
                        <motion.p initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }} className="text-gray-400 text-xl max-w-2xl mx-auto">We combine cutting-edge printing technology with the personal touch your brand deserves.</motion.p>
                    </div>
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {FEATURES.map((f, i) => (
                            <motion.div
                                ...
                                whileHover={{ y: -6 }}
                                className="bg-white/5 border border-white/10 rounded-2xl p-6 hover:bg-white/10 hover:border-brand-red/40 transition-all duration-300 group"
                            >
                                <div className="w-14 h-14 rounded-xl bg-white/10 flex items-center justify-center mb-5 group-hover:bg-brand-red/20 transition-colors duration-300">
                                    {f.icon}
                                </div>
            ...
            <section className="py-28 bg-white">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <motion.p initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} className="text-brand-red font-bold uppercase tracking-widest text-sm mb-3">Customer Stories</motion.p>
                        <motion.h2 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-4xl md:text-5xl font-black text-brand-dark mb-4">What Our Clients Say</motion.h2>
                    </div>
                    <div className="grid md:grid-cols-3 gap-8">
                        {TESTIMONIALS.map((t, i) => (
                            <motion.div
                                ...
                                viewport={{ once: true, margin: '-60px' }}
                                transition={{ duration: 0.6, delay: i * 0.12 }}
                                className="bg-gray-50 border border-gray-100 rounded-2xl p-8 hover:shadow-lg hover:border-brand-red/20 transition-all duration-300"
                            >
            ...
            <section className="py-24 bg-gradient-to-r from-brand-red via-red-600 to-red-700 relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                    ...
                    >
                        Ready to make an<br />
                        <span className="text-yellow-300">impression that lasts?</span>
                    </motion.h2>
                    <motion.p
                        initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }}
                        className="text-red-100 text-xl mb-10 max-w-xl mx-auto"
                    >
                        Start your order today and experience the difference that precision printing makes.
                    </motion.p>
                    <motion.div
